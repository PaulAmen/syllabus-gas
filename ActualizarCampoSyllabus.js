// Función para actualizar un campo específico del sílabo
function actualizarCampoSyllabus(nombreHoja, codigo, nombreCampo, valorCampo) {
  try {
...
// Función para mapear nombres de campo del frontend a encabezados de la hoja de cálculo
...
// Función para actualizar un campo desde el frontend
function actualizarCampo(carrera, codigo, nombreCampo, valorCampo) {
  ...
  return actualizarCampoSyllabus(nombreHojaFijo, codigo, nombreColumna, valorCampo);
}